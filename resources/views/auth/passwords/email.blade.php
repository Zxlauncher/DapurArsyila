              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">masukkan alamat email Anda di bawah dan kami akan mengirimkan Anda tautan untuk mengatur ulang kata sandi Anda!</p>
                  </div>
                    @if (session('status'))
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{route('login')}}">Jika sudah punya? Masuk!</a>
                  </div>
                </div>
              </div>
            </div>
