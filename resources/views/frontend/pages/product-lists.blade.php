					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">List barang</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									<h3 class="title">Tentukan Harga</h3>
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Makanan baru</h3>
                                    {{-- {{dd($recent_products)}} --}}
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="{{route('add-to-cart', $product->slug)}}" class="btn cart" data-id="{{$product->id}}">Beli</a>
													</div>
												</div>
											</div>
										</div>
