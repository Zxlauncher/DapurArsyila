...
@section('main-content')
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Menyelesaikan pembelian</h2>
                                <p>Tinggal beberapa langkah lagi untuk menyelesaikan pembelian Anda </p>
                                <!-- Form -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Nomor Telp <span>*</span></label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Alamat Pertama<span>*</span></label>
    ...
    <div class="checkbox">
        ...
        <form-group>
            ...
            <!-- <input name="payment_method"  type="radio" value="paypal"> <label> Payment Lain</label><br> -->
            ...
            <div id="creditCardDetails" style="display: none;">
                ...
                <input type="text" id="cvv" name="cvv" maxlength="3"><br>
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn" name="payment_method" value="cod" >proceed to checkout</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
